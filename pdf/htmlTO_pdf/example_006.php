...
<table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="middle"><h1 style=" font-family: Arial, Helvetica, sans-serif; font-size:24px; text-align:center; width:100%;border-bottom:#000000 solid 1px; padding-bottom:20px;">CIO CHOICE Singapore 2014 <br>
          Registration Form</h1></td>
      </tr>
      <tr>
        <td align="left" valign="middle"><h2 style=" font-family: Arial, Helvetica, sans-serif; font-size:18px; width:100%;padding:20px 0px 20px 0px; float:left">1) CONTACT INFORMATION</h2></td>
      </tr>
      <tr>
        <td align="left" valign="top">
	<table width="650" border="1" bordercolor="#000000" cellspacing="0" cellpadding="7">
      <tr>
        <td width="200" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">Company Name</td>
        <td width="450" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td>
      </tr>
      <tr>
        <td width="200" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">Company Address</td>
        <td width="450" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td>
      </tr>
      <tr>
        <td width="200" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">City</td>
        <td width="450" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td>
      </tr>
      <tr>
        <td width="200" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">State</td>
        <td width="450" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td>
      </tr>
      <tr>
        <td width="200" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">Postal Code/ ZIP</td>
        <td width="450" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">65465</td>
      </tr>
      <tr>
        <td width="200" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">Country</td>
        <td width="450" align="left" valign="top" style="padding:15px; font-family: Arial, Helvetica, sans-serif;">Singapore</td>
      </tr>
      <tr>
