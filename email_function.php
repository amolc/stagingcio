<?php 
	...
	function email_to_cio_signup($registration_name , $registration_email ,$web_url) {
		...
		$mail->Body    = '<div style=" height:1000px; padding:25px; background:#eaeaea">
    	<div style="float:left; width:100%; margin:0px 0px 25px 0px; background:white; box-shadow:0px 2px 5px #7d7c7c;">
            ...
            <div style="width:100%; float:left; padding:20px 0px; text-align:center;">
                    	<h1 style=" float:left; width:90%; font-family:Lato; font-size:26px; font-weight:bold; margin:0% 5%; padding:0px;">Thank you for your CIO CHOICE Singapore Membership application</h1>
                        
              <p style=" float:left; width:90%; display:block; font-family:Source Sans Pro; line-height:20px; margin:15px 5% 0px 5%; padding:0px; font-size:20px; font-weight:900; color:#df3030;">Your account is currently awaiting moderation </p>
                        
              <p style=" float:left; width:90%; display:block; font-family:Source Sans Pro; line-height:20px; margin:15px 5% 0px 5%; padding:0px; font-size:15px; font-weight:400;">If you application is valid we’ll be in touch shortly and provide you with your personal login details. Thanks again for your patience, in the meantime please feel free to <u>get in touch.</u></p>
...
';
	...
	function email_to_ict_signup($registration_name , $registration_email , $web_url) 
	{
		...
		$mail3->setFrom('ciochoice.sg@gmail.com', 'Cio choice');     //Set who the message is to be sent from
		$mail3->addReplyTo('ciochoice.sg@gmail.com', 'Cio choice');  //Set an alternative reply-to address
		// $mail->addAddress('raza.malik@fountaintechies.com', 'raza malik');  // Add a recipient
		...
		$mail3->Body    = '<div style=" height:100%; padding:25px; background:#eaeaea">
    	<div style="float:left; width:100%; margin:0px 0px 25px 0px; background:white; box-shadow:0px 2px 5px #7d7c7c;">
    		<div style=" float:left; width:100%; height:225px;min-height: 225px; background:url('.$web_url.'/images/cio_choice_head_bg.png) repeat-x  center top;">
            	<div style=" width:210px; height: 225px;margin:0 auto;">
            	<a href="#" style="height:245px;"><img src="'.$web_url.'/images/cio_choice_head_logo.png" alt="" width="100%" height="100%"></a>
