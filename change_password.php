...
<?php
					...
					$name = $_SESSION['user_name'];
							...
							header("Location: change_password.php?dm=ok");
							}
							
							elseif($old != $password)
							{
							
							header("Location: change_password.php?old=ok");
							}
							elseif($old == $password)
							{
							$sql2 = "update registration set registration_password='$new' where registration_email='$name'";
							mysql_query($sql2)or die(mysql_error());							
							header("Location: change_password.php?change=ok");
							}
							else
							{
							
							header("Location: change_password.php?error=ok");
							}
