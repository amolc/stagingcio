<?php
	...
	if(isset($_SESSION['admin']))
	{
       ...
       $pid = $_REQUEST['pid']; 
		...
		$result = mysql_query("SELECT * FROM gallery_videos WHERE video_id=$id");
		...
		<?php
			...
			if($_POST['upload_button'] == "Submit")
			{
				...
				$pid= mysql_real_escape_string($_POST['pid']);
					...
					if($query)
					{
						echo'<script>window.location.replace("admin_gallery_videos.php?edit=ok&id='.$pid.'");</script>';
					}
					else 
					{
						echo "error";
				...
				<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="title"  value="<?php echo $row['video_title']; ?>" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="field-1" name="date"  value="<?php echo $row['video_date']; ?>" required>
						</div>
					</div>
					...
					<div class="form-group">
							...
							<div class="form-group" style="width: 362px;margin-left: 253px;">
								<textarea style="width:362px;height:140px;" class="form-control wysihtml5 overview" name="video"  required><?php echo $row['video_path']; ?></textarea>
							</div>
					...
					<div class="form-group">
							...
							<div class="form-group" style="width: 362px;margin-left: 253px;">
								<textarea style="width:362px;height:140px;" class="form-control wysihtml5 overview" name="description"  required><?php echo $row['video_description']; ?></textarea>
							</div>
