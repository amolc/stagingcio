...
<?php include('include/admin_header/admin_header.php'); ?>
			...
			<ol class="breadcrumb bc-3">
				...
				<li class="">
					<strong><a href="admin_all_pages.php">Fag</a></strong>
				</li>
				
				<li class="active">
					<strong>Edit Fag</strong>
				</li>
			</ol>
			...
			<div class="panel-body">
				...
				<?php 
					if($_POST['submit'] == 'submit')
					{
						...
						$faq_description = mysql_real_escape_string($_POST['faq_description']);
				...
				<form   method="post" role="form" id="form1"   class="form-horizontal validate" enctype="multipart/form-data" action='<?php echo $_SERVER['PHP_SELF'] ;?>'>
						...
						<div class="form-group">
							...
							<div class="form-group" style="width: 572px;margin-left: 272px;">
								<textarea style="width:600px;height:140px;" class="form-control wysihtml5 overview" name="faq_description" id="tour_overview" required><?php echo $row['faq_description']; ?></textarea>
							</div>
