			...
			if ($_FILES["file"]["name"] != ""){
				...
				<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
					...
					<div class="form-group">
						...
						<div><img src="upload/news/<?php echo $row['news_img'];?>" width=145px alt="" /></div>
					</div>
					...
					<div class="form-group">
							...
							<div class="form-group" style="width: 362px;margin-left: 253px;">
								<textarea style="width:362px;height:140px;" class="form-control wysihtml5 overview" name="description" id="tour_overview" required><?php echo $row['news_description']; ?></textarea>
							</div>
