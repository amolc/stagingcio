...
<div class="sidebar-menu">
	...
	<ul id="main-menu" class="">
		...
		<li>
			<a href="#"><i class="entypo-layout"></i><span>Advisory Panel</span></a>
			<ul>
				<li>
		...
		<li>
			...
			<ul>
				...
				<li>
					<a href="admin_all_video.php"><span>All Videos</span></a>
				</li>
		...
		<li>
			<a href="#"><i class="entypo-layout"></i><span>Events</span></a>
			<ul>
				<li>
		...
		<li>
			<a href="#"><i class="entypo-layout"></i><span>Registration</span></a>
			<ul>
				<li>
		...
		<li>
			<a href="admin_contact_us.php"><i class="entypo-layout"></i><span>Contact Us</span></a>

		</li>
		<li>
			<a href="admin_add_social_link.php"><i class="entypo-layout"></i><span>Add Social Link</span></a>

		</li>
		<li>
			<a href="#"><i class="entypo-layout"></i><span>Setting</span></a>
			<ul>
				<li>
