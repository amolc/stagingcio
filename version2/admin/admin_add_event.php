...
$facebook = new Facebook(array(
  ...
  'appId'  => '174965245977678',//'174965245977678',

  'secret' => 'b1468bb9111d804ee97c223ec91a7900',//'b1468bb9111d804ee97c223ec91a7900',
   'cookie' => true
...
$feedURL = "https://graph.facebook.com/".$facebook->getUser()."/albums?access_token=".$token;
...
$albums_list = $facebook->api("/me/albums"); //get albums
...
<div class="row">
	<div class="col-md-12">
		...
		<?php
			...
			if(isset($_POST['upload_button']) && $_POST['upload_button'] == "Submit"){
				...
				$vide_query1="INSERT into event_videos (event_id,event_video_code,event_video_inserted_date) VALUES('$event_id','$youtube1','$event_video_inserted_date')";
				mysql_query($vide_query1);	
				$vide_query2="INSERT into event_videos (event_id,event_video_code,event_video_inserted_date) VALUES('$event_id','$youtube2','$event_video_inserted_date')";
				mysql_query($vide_query2);
					// if($query)
					// {
						// echo "Event Add Successful";
					// }				
				...
				<form role="form" action="<?php $_SERVER["PHP_SELF"];?>" method="post"  enctype="multipart/form-data" class="form-horizontal form-groups-bordered">
					...
					<?php $albums_list = $facebook->api("/me/albums"); //get albums ?>
					<?php print_r($albums_list); ?>

					<?php 	foreach ($albums_list as $value) :?>
						<?php echo $value['name']; ?>
					<?php endforeach; ?>
					...
					<div class="form-group">
							...
							<div class="form-group" style="width: 362px;margin-left: 253px;">
								<textarea style="width:362px;height:140px;" class="form-control wysihtml5 overview" name="youtube1" id="youtube" required></textarea>
							</div>
					...
					<div class="form-group">
							...
							<div class="form-group" style="width: 362px;margin-left: 253px;">
								<textarea style="width:362px;height:140px;" class="form-control wysihtml5 overview" name="youtube2" id="youtube" required></textarea>
							</div>
