													...
													<div class="event_overview fl">
														...
														<div class="facebook_scroll owl-carousel" style="clear: both;" >
														  <?php
															...
															{
	http://staging.cio-choice.sg/timthumb.php?src=admin/
																$fb_image = $res1['event_fb_pic'];
																if (!empty($fb_image)) { 
																//echo ' <img src="timthumb.php?src=admin/user_data/'.$fb_image.'&h=auto&w=131&zc=1" width="131" height="auto">';
															?>
