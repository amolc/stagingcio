...
(function (e) {
    ...
    function n(n, i) {
        ...
        else this.offset = m.left + this.minus; if (this.options.hv_switch) this._set_text_div_width_ver();
    ...
    n.prototype = {
        ...
        show_text: function (t, n, r) {
            ...
            else this.options.vert_text_mode = 0; if (typeof this.options.map[t].link_url != "undefined") {
        ...
        _preset_all_children_parameters: function (t, n) {
            ...
            for (s = 0; s < this.max_show; s++) {
                ...
                else i = 0; if (this.options.keep_on_top_middle_circle) o[s] = {
                    i: s,
                    pos: r.new_pos
                };
        ...
        _animation_done: function () {
            ...
            else e = this.max_show + (this.max_show - 2); if (this.anim_counter >= e) {
                this.anim_counter = 0;
                this.lock = 0;
                if (this.click == 1) {
