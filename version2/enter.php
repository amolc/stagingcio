                                                ...
                                                <div class="our_advisory_panel mrgn_top" style="height:auto;">
                                                  <div class="overview_left fl">
                                               	  ...
                                               	  <div class="overview_right fr">
                                                      ...
                                                      <p style="margin:0px 0px 20px 20px;">If you are an ICT Vendor we would like to invite you to register your Product,<br>Service or solution in the relevant ICT category. The categories are part of the ICT segments - hardware, software &amp; services across the various ICT domains - business apps, infra, security, mobility, big data, analytics, etc.</p>
...
<a href="CIO-CHOICE-RF-Full_v1.1_(Writable).rar" class="pdf">Download the ICT Vendor Application form</a>
</div>
                                                    </div>
