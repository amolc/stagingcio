...
include('sql_config/database/cio_db.php'); 
													$advisory_query = mysql_query("select advisory_image as image from advisory_panel");
													// $pic_name[]="";
													...
													$outputArray = array();
												while( $row = mysql_fetch_assoc( $advisory_query ) ){
												$row1 = $row['advisory_image'];
												// $path="admin/upload/";
													array_push($outputArray, $row);
												}
												
												  $data1 = json_encode($outputArray);
												    // $json = preg_replace('/"([^"]+)"\s*:\s*/', '$1:', $data1);
												    $json = preg_replace('/"([a-zA-Z]+[a-zA-Z0-9_]*)":/','$1:',$data1);
												    // $json = preg_replace('/\s*\:\s*"([-+]?[0-9]*\.?[0-9]+)"/', "'':$1", $data1);
												// echo $json;
...
<script type="text/javascript">
	(function($){
	   ...
	   // var image_array = $('table').find( 'tbody' ).children( 'tr' ).map(function(){
...
// alert(image_array);
			...
			// image_array = [{image: 'admin/upload/download (2).jpg'},{image: 'admin/upload/5-day-hong-kong.png'}];
			var mystring ='<?php echo $json ;?>';
			var data_joson  = mystring.replace(/"/g, "'");
			// alert(data_joson);
			 var image_array = new Array();
			image_array =<?php echo $data1 ;?>;
			 // image_array = data_joson;
			
			
			// image_array = '<?php echo json_encode($outputArray);?>';
				// delete image_array["image"];
			
		
		
			// image_array = [{"image":"admin/upload/download (2).jpg"}];
			// alert(image_array);
			/*image_array = [
...
<body>
										...
										<div style="padding-top:50px;height: 560px;" id="advisory_wrapper">
												...
												<div style="max-width: 861px!important;" class="content_slider_wrapper" id="slider1">
												<?php
												...
												?>
													<div class="circle_slider_text_wrapper" id="sw<?php echo $counter;?>" style="display: none;height: 263px;overflow: hidden;margin-left: 92px;">
													<!-- content for the first layer, id="sw0" -->
														<div style="width: 79%;" class="content_slider_text_block_wrap">
														<!-- "content_slider_text_block_wrap" is a div class for custom content -->
															<h3><?php echo $advisory_name ; ?></h3><br />
															
															<span style="display:none;"><span class="bold">E-mail: </span><a href="#"><?php echo $advisory_name ; ?></a></span><br /><br />
															<span><span class="bold"></span><?php echo $advisory_description ; ?></span><br /><br /><br />
															<!--<a href="#" class="button_socials button_hover_effect fb" data-hovercolor="#496dba" data-hoveroutcolor="#3b5a9a"></a>
															<a href="#" class="button_socials button_hover_effect tw" data-hovercolor="#4bb8e7" data-hoveroutcolor="#23aae1"></a>
															<a href="#" class="button_socials button_hover_effect pin" data-hovercolor="#de343d" data-hoveroutcolor="#cc2129"></a>
															<a href="#" class="button_socials button_hover_effect yt" data-hovercolor="#fd0013" data-hoveroutcolor="#bb000e"></a> -->
														</div>
														<div class="clear"></div>	
													</div>
													<?php
